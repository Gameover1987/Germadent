...
RETURN 
(
	SELECT pg.BranchTypeID, pg.PriceGroupID, pg.PriceGroupName, pg.IsObsoleteGroup, pp.PricePositionID, pp.PricePositionCode, pp.PricePositionName, pp.IsObsoletePosition, m.MaterialID, m.MaterialName, prod.ProductID AS ProductID, prod.ProductName AS ProductName, p.DateBeginning, p.DateEnd, p.PriceSTL, p.PriceModel
