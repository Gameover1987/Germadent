...
RETURN 
(
	SELECT pg.BranchTypeID, pg.PriceGroupID, pg.PriceGroupName, pp.PricePositionID, pp.PricePositionCode, pp.PricePositionName, m.MaterialID, m.MaterialName, prod.ProstheticsID, prod.ProstheticsName, p.DateBeginning, p.DateEnd, p.PriceSTL, p.PriceModel
	FROM PriceGroups pg
